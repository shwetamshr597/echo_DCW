...
class Elasticsearch
{
    ...
    public const OPENSEARCH_ENGINE = 'opensearch';
    ...
    private function isOpenSearchEngineType(): bool
    {
        $elasticInfo = $this->getClient()->info();

        return ($elasticInfo['version']['distribution'] ?? null) === self::OPENSEARCH_ENGINE;
    }
}
