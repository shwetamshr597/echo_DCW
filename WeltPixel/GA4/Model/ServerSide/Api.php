...
class Api extends \Magento\Framework\Model\AbstractModel implements ApiInterface
{
    ...
    {
        $purchaseParams = $purchaseEvent->getParams();
        try {
    ...
    {
        $refundParams = $refundEvent->getParams();
        try {
    ...
    {
        $signupParams = $signupEvent->getParams();
        try {
    ...
    {
        $loginParams = $loginEvent->getParams();
        try {
    ...
    {
        $viewItemParams = $viewItemEvent->getParams();
        try {
    ...
    {
        $viewItemListParams = $viewItemListEvent->getParams();
        try {
    ...
    {
        $selectItemParams = $selectItemEvent->getParams();
        try {
    ...
    {
        $searchParams = $searchEvent->getParams();
        try {
    ...
    {
        $addToCartParams = $addToCartEvent->getParams();
        try {
    ...
    {
        $removeFromCartParams = $removeFromCartEvent->getParams();
        try {
    ...
    {
        $viewCartParams = $viewCartEvent->getParams();
        try {
    ...
    {
        $beginCheckoutParams = $beginCheckoutEvent->getParams();
        try {
    ...
    {
        $addPaymentInfoParams = $addPaymentInfoEvent->getParams();
        try {
    ...
    {
        $addShippingInfoParams = $addShippingInfoEvent->getParams();
        try {
    ...
    {
        $addShippingInfoParams = $addToWishlistEvent->getParams();
        try {
